...
season_year,
CASE 
	WHEN season_year = 2009 THEN team_2010
	WHEN season_year = 2010 THEN team_2011
	WHEN season_year = 2011 THEN team_2012
	WHEN season_year = 2012 THEN team_2013
	ELSE NULL
END AS next_team,
MAX(injury_flag) AS injury_max,
SUM(injury_flag) AS injury_sum,
